...
namespace Map
{
    public partial class Settings : PhoneApplicationPage
    {
        ...
        void Settings_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            newAppSettings._AutoStartMusic = _appSettings._AutoStartMusic;
            newAppSettings._EnableLocationAccess = _appSettings._EnableLocationAccess;
            LoadUI();
            ...
            tgMusic.Checked += tgMusic_Checked;
            tgMusic.Unchecked += tgMusic_Unchecked;
            cbxLocationAccess.Checked += cbxLocationAccess_Checked;
            cbxLocationAccess.Unchecked += cbxLocationAccess_Unchecked;
        ...
        void cbxLocationAccess_Unchecked(object sender, RoutedEventArgs e)
        {
            newAppSettings._EnableLocationAccess = false;
        }

        void cbxLocationAccess_Checked(object sender, RoutedEventArgs e)
        {
            newAppSettings._EnableLocationAccess = true;
            
        }

        void tgMusic_Unchecked(object sender, RoutedEventArgs e)
        {
            newAppSettings._AutoStartMusic = false;
        }

        void tgMusic_Checked(object sender, RoutedEventArgs e)
        {
            newAppSettings._AutoStartMusic = true;
        }
        ...
        void LoadUI()
        {
            ...
            tgMusic.IsChecked = newAppSettings._AutoStartMusic;
            cbxLocationAccess.IsChecked = newAppSettings._EnableLocationAccess;
