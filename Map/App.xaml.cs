...
namespace Map
{
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            //{
            //    Map.App.RootFrame.Navigate(new Uri("/Useraccountmanager.xaml", UriKind.Relative));
            ...
            //else
            //{
            //    Map.App.RootFrame.Navigate(new Uri("/UserInfo.xaml", UriKind.Relative));
            //}
        ...
        private void InitializeLanguage()
        {
            try
            {
                ...
                {
                    var appSettings = (AppSettings)settings["AppSettings"];
